...
user in an INI file next to DPIConverterPortable.exe called DPIConverterPortable.ini.
...
copy AppNamePortable.ini from this directory to DPIConverterPortable.ini next to
DPIConverterPortable.exe. The options in the INI file are as follows:
